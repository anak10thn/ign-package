Summary:IGOS Nusantara Control Panel module ign-cpanel-autostart
Name:ign-cpanel-autostart
Version:1.0.1
Release:12.2.8
License:GPLv2
...
%defattr(-,root,root,-)
%dir 
/usr/share/ign-cpanel/modules/ign-cpanel-autostart
%config %attr(0755,root,root) /usr/share/ign-cpanel/modules/ign-cpanel-autostart/*
