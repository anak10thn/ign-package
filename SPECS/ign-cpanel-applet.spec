Summary:	IGOS Nusantara Control Panel module ign-cpanel-applet
Name:		ign-cpanel-applet
Version:	1.0.1
Release:	12.2.8
License:	GPLv2
...
%defattr(-,root,root,-)
%dir 
/usr/share/cinnamon/applets/ign-cpanel@anak10thn/
%config %attr(0755,root,root) /usr/share/cinnamon/applets/ign-cpanel@anak10thn/
