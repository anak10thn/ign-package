Summary:	IGOS Nusantara Control Panel module ign-cpanel-packagemanager
Name:		ign-cpanel-packagemanager
Version:	1.0.1
Release:	12.2.8
License:	GPLv2
...
%defattr(-,root,root,-)
%dir 
/usr/share/ign-cpanel/modules/ign-cpanel-packagemanager
%config %attr(0755,root,root) /usr/share/ign-cpanel/modules/ign-cpanel-packagemanager/*
